...
const UUID_ESP32_SERVICE = 'fb2d65ba-2545-11eb-adc1-0242ac120002';
const UUID_ESP32_CHARACTERISTIC_1 = '07f94da4-2546-11eb-adc1-0242ac120002';
const UUID_ESP32_CHARACTERISTIC_2 = '524a38aa-2546-11eb-adc1-0242ac120002';
    ...
    methods: {
        ...
        esp32_write: async function(){
            ...
            //for( var i = 0 ; i < buffer.length && i < mask.length ; i++ )
              //  buffer[i] ^= mask[i];
            await esp32_chars.get(UUID_ESP32_CHARACTERISTIC_2).writeValue(encoder.encode(this.wifi_password));
